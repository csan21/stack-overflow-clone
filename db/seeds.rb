...
for i in (0..randvote)
  Vote.create(votable_id: 3, votable_type: "Post", voter_id: i, upvote?: truefalse)
end
...
for i in (0..randvote)
  Vote.create(votable_id: 4, votable_type: "Post", voter_id: i, upvote?: truefalse)
end
...
for i in (0..randvote)
  Vote.create(votable_id: 5, votable_type: "Post", voter_id: i, upvote?: truefalse)
end
